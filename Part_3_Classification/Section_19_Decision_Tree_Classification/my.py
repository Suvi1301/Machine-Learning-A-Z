...
# Feature Scaling is not required for Decision Trees as it doesn't rely on Euclidean distance
# But we compromise this for plotting in a higher resolution later.
...
plt.title('Decision Tree (Training (o) and Testing (x) Set)')
plt.xlabel('Age')
